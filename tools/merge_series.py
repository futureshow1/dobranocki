...
MANUAL2 = [
    ...
    ("qrE8OERXtVU", "Węgry: Gustaw i Wodnik Szuwarek", "Gustaw", "Gustaw pesymista", 1970, "full"),
    ("a74nS2eAN4A", "Węgry: Gustaw i Wodnik Szuwarek", "Gustaw", "Gustaw łamie prawo", 1970, "full"),
    ("JhkEq3fDQzI", "Węgry: Gustaw i Wodnik Szuwarek", "Gustaw", "Gustaw oszukuje", 1970, "full"),
    ("-d06Bz3U2OQ", "Węgry: Gustaw i Wodnik Szuwarek", "Gustaw", "Gustaw odpoczywa (emisja PTK)", 1970, "full"),
    ("iqbpK30LwHI", "Węgry: Gustaw i Wodnik Szuwarek", "Wodnik Szuwarek", "Wodnik Szuwarek — odcinek", 1978, "full"),
